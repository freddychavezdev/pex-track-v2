...
1. Instalar Docker Desktop o vincular un proyecto Supabase para aplicar y verificar las migraciones.
2. Sustituir datos de muestra por consultas de órdenes y cuadrillas.
3. Implementar importación validada de CSV.
4. Crear el módulo Android con ubicación y cola offline.
